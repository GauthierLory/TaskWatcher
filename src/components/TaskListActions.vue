<template>
  <el-button @click="restartTask(taskID)" circle type="primary">
    <el-icon>
  ...
  <el-button @click="copyToClipboard(taskname)" circle type="default">
    <el-icon>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round"
  ...
  <el-button type="danger" @click="deleteTask(taskID)">
    <el-icon>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round"
